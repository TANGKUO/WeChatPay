...
public class StarerIntentService extends IntentService {
    ...
    public static void startActionStart(Context context, String packageName, String activityName) {
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_START.equals(action)) {
                ...
                handleActionStart(packageName, activityName);
            }
        }
    }

    private void handleActionStart(String packageName, String activityName) {
        ...
        if (startWithExposed) {
            ...
            startWithExposed(packageName, activityName);
        }
    }
    ...
    private void startWithExposed(String packageName, String activityName) {
        Log.v(Const.PACKAGE_TAG, "Start with exposed");
        Intent starter = getPackageManager().getLaunchIntentForPackage(packageName);
